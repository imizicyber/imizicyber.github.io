...
**Second priority (SEO and trust compounding):**
5. **Blog internal linking audit** — link all 16 posts to each other and to service pages systematically.
6. **Compliance mapping specificity** — add actual BNR directive numbers to pentest and compliance pages.
7. **LinkedIn Insight Tag** — free to install, enables future retargeting.
8. **WhatsApp GA4 tracking** — so you know which pages drive WhatsApp leads.

**Defer (important but not urgent):**
9. **CSP hardening** — architectural effort, do in a dedicated phase.
10. **Email follow-up sequences** — needs Formspree plan or third-party email tool.
11. **Performance deep-optimisation** — Astro static output is already good; optimise after measuring real data.
12. **Additional resources** — add 2-3 more lead magnets when current ones are tracked properly.
