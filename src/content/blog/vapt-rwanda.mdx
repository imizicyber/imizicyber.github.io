...
<Callout type="info">
**USSD testing is often overlooked.** If your organisation offers USSD-based services (like \*182# banking), this must be included in scope. USSD platforms handle real financial transactions and are frequently under-tested. Read our [USSD security testing guide](/blog/ussd-security-testing/) for more detail.
</Callout>
...
We are an OSCP-certified penetration testing firm based in Kigali, delivering VAPT engagements for banks, fintechs, telecom operators, and government institutions across Rwanda and East Africa. Our assessments combine automated scanning with deep manual testing by experienced consultants, and our reports are structured to satisfy BNR, ISO 27001, and PCI DSS requirements. [Contact us](/#contact) to scope your next VAPT engagement. We will provide a detailed proposal within 48 hours.
