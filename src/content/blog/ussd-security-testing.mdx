...
We are an OSCP-certified penetration testing firm based in Kigali with specific expertise in USSD security testing. Most penetration testing providers do not test USSD at all. We do, and we have the methodology and tooling to assess gateway integrations, session management, and transaction flow manipulation that standard web application testing completely misses. [Contact us](/#contact) to include USSD in your next security assessment.
