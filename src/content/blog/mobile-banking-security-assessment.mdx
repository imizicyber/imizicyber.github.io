...
We are an OSCP-certified penetration testing firm based in Kigali. Mobile banking security assessment is one of our core specialisations. We test the app, the APIs behind it, and the business logic that ties them together. If your mobile banking app has never been tested by someone who understands certificate pinning bypass, BOLA on banking endpoints, and USSD-to-app transaction flows, [contact us](/#contact) to scope an assessment. We deliver reports that satisfy BNR requirements and give your development team clear, actionable remediation guidance.
