...
We are an OSCP-certified penetration testing firm based in Kigali. We work with BNR-regulated institutions across Rwanda to deliver the security assessments that compliance requires: web application testing, API security, mobile banking, USSD, network infrastructure, and social engineering. Our reports are structured to satisfy BNR examination requirements and give your compliance team the documentation they need.

For a full overview of our assessment methodology, see our [security assessments](/services/security-assessments/) service page. For penetration testing scope and deliverables, see our [penetration testing](/services/penetration-testing/) service page. [Contact us](/#contact) to scope your next BNR-compliant VAPT engagement.
